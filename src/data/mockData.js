export const TRAINERS = [
  { id: 1, name: "Carlos Mendes", specialty: ["Hipertrofia", "Força"], price: 110, rating: 4.7, reviews: 18, location: "Mogi das Cruzes", avatar: "CM", color: "#7c3aed", available: true },
  ...
  { id: 3, name: "Ricardo Lima", specialty: ["Natação", "Resistência"], price: 120, rating: 4.6, reviews: 11, location: "Mogi das Cruzes", avatar: "RL", color: "#059669", available: false },
  { id: 4, name: "Juliana Costa", specialty: ["Pilates", "Reabilitação"], price: 100, rating: 4.9, reviews: 15, location: "Itaquaquecetuba", avatar: "JC", color: "#dc2626", available: true },
];
