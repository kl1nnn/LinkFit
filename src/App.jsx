...
const todayLabel = "Segunda-feira, 4 de maio de 2026";
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <button title="Notificacoes" style={{ background: "none", border: `1px solid ${COLORS.border}`, color: COLORS.muted, cursor: "pointer", fontSize: 14, width: 34, height: 34, borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
              ○
            </button>
